          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Pagos  <small>confirmados</small></h3>
              </div>
           </div>
            <div class="row">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">Listado de usuarios con pago confirmado</p>
                    <table id="datatable-buttons" class="table table-striped table-bordered" >
                     ...
                     <tbody id="showdataUsuarioTienda">
                        <?php
                             if(empty($pagos_exitosos)){
                               }else {
                                     $contador =0;
                                     foreach ($pagos_exitosos as $fila): 
                                     $contador ++;
                                      ?>
                        <tr>
                          <td><?= $contador;?></td>
                          <td><?= $fila->usuario;?></td>
                          <td><?= $fila->tipo_plan_pagado;?></td>
