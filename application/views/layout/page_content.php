                    ...
                    <div class="col-md-12 col-lg-4 col-sm-12 col-xs-12">
                        <div class="panel">
                            <div class="p-20">
                                <div class="row">
                                    <div class="col-xs-8">
                                        <h4 class="m-b-0">Ganancias Totales</h4>
                            ...
                            <div class="panel-footer bg-extralight">
                                <ul class="earning-box">
                                    <li>
                                        <div class="er-row">
                                            <div class="er-pic"><img src="<?php echo base_url();?>assets/plugins/images/users/genu.jpg" alt="varun" width="60" class="img-circle"></div>
                                            <div class="er-text">
                                    ...
                                    <li>
                                        <div class="er-row">
                                            <div class="er-pic"><img src="<?php echo base_url();?>assets/plugins/images/users/govinda.jpg" alt="varun" width="60" class="img-circle"></div>
                                            <div class="er-text">
                                    ...
                                    <li>
                                        <div class="er-row">
                                            <div class="er-pic"><img src="<?php echo base_url();?>assets/plugins/images/users/pawandeep.jpg" alt="varun" width="60" class="img-circle"></div>
                                            <div class="er-text">
